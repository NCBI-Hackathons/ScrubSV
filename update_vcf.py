...
def _parse_args():
    ...
    parser.add_argument(
        '-v', '--verbose', action='store_true', help='TSVs to apply to input vcf.')
    parser.add_argument(
        "--output",
        type=str,
...
if __name__ == '__main__':
    ...
    if args.verbose:
        logging.basicConfig(filename='janitorDEBUG.log', level=logging.DEBUG, filemode='w')
